...
public class AgendaEventos {
    ...
    // ordem crescente de data, por isso o uso do treemap que faz a ordenação no map
    ...
    public void obterProximoEvento() {
        ...
        // entreSet -> retorna um set que cada elemento do tipo mat.entry
        // e assim se consegue uma determinada key e um determinado values
        for (Map.Entry<LocalDate, Evento> entry : eventosMap.entrySet()) {
            // pega a chave do tipo date
            LocalDate dataEvento = entry.getKey();
